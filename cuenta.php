    ...
    <div class="register-container">
        ...
        <form action="cuenta2.php" method="POST" onsubmit="return validarFormulario();">
            ...
            <div class="input-group">
                ...
                <input type="email" id="email" name="email" placeholder="Ejemplo: a12345678@ceti.mx" required>
                <span id="error-email" style="color: red;"></span>
            </div>
            <div class="input-group">
                <label for="contrasenia">Contraseña:</label>
                <input type="password" id="contrasenia" name="contrasenia" placeholder="Mínimo 8 caracteres" required minlength="8">
                <span id="error-password" style="color: red;"></span>
            </div>
            <button type="submit">Crear Cuenta</button>
        </form>
        <p class="login-link">¿Ya tienes una cuenta? <a href="login.php"><strong>Iniciar sesión</strong></a></p>
    </div>
</body>
</html>
